...
namespace FirstCRUDCSharp.LocalDBDataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[People] WHERE (([PeopleID] = @Original_PeopleID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)))";
...
SELECT PeopleID, Name, Company, Telephone, Email, Client, LastCall FROM People WHERE (PeopleID = SCOPE_IDENTITY())";
...
SELECT PeopleID, Name, Company, Telephone, Email, Client, LastCall FROM People WHERE (PeopleID = @PeopleID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FirstCRUDCSharp.Properties.Settings.Default.LocalDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PeopleID, Name, Company, Telephone, Email, Client, LastCall FROM dbo.Peopl" +
                "e";
        ...
        public virtual int Delete(int Original_PeopleID, string Original_Name, string Original_Company, string Original_Telephone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall) {
        ...
        public virtual int Update(string Name, string Company, string Telephone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> LastCall, int Original_PeopleID, string Original_Name, string Original_Company, string Original_Telephone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall, int PeopleID) {
            if ((Name == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[19].Value = ((int)(PeopleID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Company, string Telephone, string Email, global::System.Nullable<bool> Client, global::System.Nullable<global::System.DateTime> LastCall, int Original_PeopleID, string Original_Name, string Original_Company, string Original_Telephone, string Original_Email, global::System.Nullable<bool> Original_Client, global::System.Nullable<global::System.DateTime> Original_LastCall) {
            return this.Update(Name, Company, Telephone, Email, Client, LastCall, Original_PeopleID, Original_Name, Original_Company, Original_Telephone, Original_Email, Original_Client, Original_LastCall, Original_PeopleID);
        }
    }
